      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center">
        ...
        <div>
          ...
          <div className="mt-8 flex flex-wrap gap-3 text-xs text-gray-400">
            <span className="px-3 py-1 rounded-full border border-white/10">Python · SQL · R</span>
            <span className="px-3 py-1 rounded-full border border-white/10">Power BI · Tableau</span>
            <span className="px-3 py-1 rounded-full border border-white/10">Advanced Analytics – Big Data</span>
          </div>
        </div>
          ...
          <div className="relative rounded-3xl border border-white/10 bg-gradient-to-br from-blue-950/80 via-slate-900 to-slate-950 p-6 shadow-2xl shadow-blue-900/40">
            ...
            <div className="flex justify-between items-center mb-4">
              <div>
                ...
                <p className="text-sm font-semibold">IT Business Analyst @ Agile Solutions</p>
              </div>
            ...
            <div className="space-y-3 text-sm text-gray-300">
              <p>
                Working with CRM, contact center, and cloud dialer systems to optimize
                communication and operational efficiency.
              </p>
              <p>
                Strong experience in Python, SQL, and BI tools across projects in Azerbaijan
                and Poland.
              </p>
            </div>
